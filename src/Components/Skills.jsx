  ...
  return (
    <div id="skills" className="fix w-full h-screen bg-[#0a192f] text-gray-300">
      <div className="max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full">
        <div className="py-8">
          <p className="text-4xl font-bold inline border-b-4 border-pink-600 ">Erfarenheter</p>
          <p className="py-2">//Dessa tekniker är vad vad jag har erefarenhet av:</p>
        </div>
        <div className="w-full grid grid-cols-2 sm:grid-cols-4 gap-4 text-center py-4">
          ...
          <div className="shadow-md shadow-[#040c16] hover:scale-110 duration-500">
            <img className="w-20 mx-auto" src={reactnative} alt="reactnative icon" />
